...
module.exports = function loadGeneratorDef(options) {
  ...
  if (!generatorDef) {
    ...
    if (generatorModulePathOrPkgName) {
      ...
      gnfErrorMsg = 'No generator called `' + options.generatorType + '` found; perhaps you meant `sails generate api ' + options.generatorType + '`?';

    }//</else>

    // Add suffix
    gnfErrorMsg += '\n';
    gnfErrorMsg += 'For help, see http://sailsjs.com/docs/concepts/extending-sails/generators.';
