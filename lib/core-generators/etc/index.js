...
module.exports = {
  ...
  targets: {
    ...
    './.eslintrc':                   { copy: '../../../shared-templates/eslintrc.template' },
    //'./.jshintrc':                   { copy: '../../../shared-templates/jshintrc.template' },// FUTURE: Make final decision on whether to bring this back.
  ...
  after: function (scope, done) {
    done.log.info('Replaced: `.gitignore`, `.jshintrc`, `.editorconfig`, `.npmignore`, `.travis.yml`, & `appveyor.yml`.');
