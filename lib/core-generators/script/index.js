...
module.exports = {
  ...
  before: function (scope, done){
    ...
    // Be kind -- transform slashes to dots when creating the scriptName.
    scope.scriptName = roughName.replace(/\/+/g, '.');
    ...
    // After transformation, the scriptName must contain only letters, numbers, and dots--
