...
module.exports = {
  ...
  targets: {
      ...
      //
      {
        ...
        generator: {
          ...
          targets: {
            ...
            '.': [
              {
                ...
                generator: {
                  targets: {
                    ...
                    './views/401-invalid-or-expired-token.ejs': { onlyIf: 'caviar', copy: 'views/401-invalid-or-expired-token.ejs' },
            ...
            './api/controllers/entrance/signup.js':  { onlyIf: 'caviar', copy: 'api/controllers/entrance/signup.js.template' },
            ...
            './api/controllers/view-homepage.js':  { onlyIf: 'caviar', copy: 'api/controllers/view-homepage.js.template' },
            ...
            './api/policies/is-logged-in.js': { copy: 'api/policies/is-logged-in.js', overridable: 'api/policies/is-logged-in.js' },
            ...
            // /config
            './config': { folder: {} },
            './config/blueprints.js': { copy: 'config/blueprints.js', overridable: 'config/blueprints.js' },
            ...
            './assets': {
              ...
              generator: {
                targets: {
                  ...
                  './dependencies/bootstrap-4/bootstrap-grid.css': { onlyIf: 'caviar', copy: 'assets/dependencies/bootstrap-4/bootstrap-grid.css' },
                  './dependencies/bootstrap-4/bootstrap-reboot.css': { onlyIf: 'caviar', copy: 'assets/dependencies/bootstrap-4/bootstrap-reboot.css' },
                  './dependencies/bootstrap-4/bootstrap.css': { onlyIf: 'caviar', copy: 'assets/dependencies/bootstrap-4/bootstrap.css' },
                  './dependencies/bootstrap-4/popper.js': { onlyIf: 'caviar', copy: 'assets/dependencies/bootstrap-4/popper.js' },
                  './dependencies/bootstrap-4/bootstrap.js': { onlyIf: 'caviar', copy: 'assets/dependencies/bootstrap-4/bootstrap.js' },
    ...
    //'./.jshintrc':       { copy: 'jshintrc.template' },// FUTURE: Make final decision on whether to bring this back.
    './.htmlhintrc':     { copy: 'htmlhintrc.template', overridable: '.htmlhintrc' },
