      ...
      //
      {
        ...
        generator: {
          ...
          targets: {
            ...
            './api/policies/isLoggedIn.js': { copy: 'api/policies/isLoggedIn.js', overridable: 'api/policies/isLoggedIn.js' },
            './api/policies/isAdmin.js':    { onlyIf: 'caviar', copy: 'api/policies/isAdmin.js', overridable: 'api/policies/isAdmin.js' },
