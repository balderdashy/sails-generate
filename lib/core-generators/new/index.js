            ...
            '.': [
              {
                ...
                generator: {
                  targets: {
                    ...
                    './views/pages': { onlyIf: 'caviar', folder: {} },
                    ...
                    './views/pages/homepage.ejs': { onlyIf: 'caviar', copy: 'views/pages/homepage.ejs' },
            ...
            './assets': {
              ...
              generator: {
                targets: {
                  ...
                  // TODO: rest of images and rename where they are used to not be @2x, since this project doesn't assume
                  // anything about what you want to do as far as retina.js etc.
