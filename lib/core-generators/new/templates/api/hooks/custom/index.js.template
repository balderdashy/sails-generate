...
module.exports = function defineCustomHook(sails) {
  ...
  return {
    ...
    initialize: async function (done) {
      ...
      sails.log.debug('Initializing hook... (`api/hooks/custom`)');
...
---------------------------------------------------------------------${verboseSuffix}`);
      ...
      // Set additional config keys based on whether Stripe and Mailgun config are available.
      // These will determine whether or not to enable various email and billing features.
        ...
        '/*': {
          ...
          fn: async function(req, res, next){
            ...
            if (req.method === 'GET') {
              ...
              // Include information on the locals as to whether billing and email
