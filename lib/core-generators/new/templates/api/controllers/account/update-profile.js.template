module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    if (changeEmailAddress && sails.config.custom.enableEmailFeatures) {
      changes.emailProofToken = await sails.stdlib('strings').random({ style: 'url-friendly' });
