...
module.exports = function(grunt) {
  grunt.registerTask('buildProd', [
    'polyfill:prod', // <-- Remove this if you don't need/want to transpile code to ES2015 (see note below).
    'compileAssets',
    'babel',         // <-- Remove this if you don't need/want to transpile code to ES2015 (see note below).
    'concat',
    'uglify',
    'cssmin',
    'linkAssetsBuildProd',
