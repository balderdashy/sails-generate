 ...
 * older browsers can run code that uses things like Promise.  This is typically run as part of
 * the "transpile" task, which also uses Babel to transpile ES6 code to ES2015.
 *
...
module.exports = function(grunt) {
  ...
  grunt.registerTask('polyfill:dev', 'Add the polyfill file to the top of the list of files to concatenate', function() {
