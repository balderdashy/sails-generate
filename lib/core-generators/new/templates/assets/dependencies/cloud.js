 ...
 * Copyright (c) 2015-2017, Mike McNeil, Scott Gress, Sails Co. (https://sailsjs.com/studio)
 * MIT License
 * ---------------------------------------------------------------------------------------------
 * ## Basic Usage
 *
 ...
 *
 * ```
 * Cloud.setup({  doSomething: 'POST /api/v0.5/somethings/:id/do'  });
 * ```
...
(function(global, factory){
   ...
   *   methods: {
   *     doSomething: 'PUT /api/v0.5/projects/:id',
   *     // ...
   *   }
   * });
   * ```
    ...
    var methods = _.reduce(options.methods, function(memo, appLevelSdkEndpointDef, methodName) {
      ...
      memo[methodName] = function (argins) {
        ...
        var deferred = {
          ...
          // >
          // > (Also check out the commit history of the `caviar` repo.)
          // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        //////////////////////////////////////////////////////////////////////
        // e.g. "POST /api/v1/machines/foo/inputs/bar"
        else if (typeof appLevelSdkEndpointDef === 'string') {
