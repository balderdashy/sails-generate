 ...
 *   (This can be useful for building UI controls that aren't necessarily tied
 *   to any particular AJAX call, but where it's helpful to be able to rely on
 *   the browser's default handling of forms -- e.g. the <ENTER> key, etc.)
 * -----------------------------------------------------------------------------
 */
