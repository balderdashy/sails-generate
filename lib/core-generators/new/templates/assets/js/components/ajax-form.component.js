 ...
 * @type {Component}
 *
 * @event after-submitting   [emitted after the server responds with a 2xx status code]
 * @event submit             [emitted when the form is initially submitted]
 *
 * • If "action" is provided, then the "afterSubmit" event will be emitted,
 *   but the "submit" event will NOT be emitted.
 *
 * • The opposite is also true:  If "action" is NOT provided, then the
 *   "afterSubmit" event will NOT be emitted, and the "submit" event will
