...
parasails.registerComponent('account-notification-banner', {
  ...
  template: `
  <div>
    <div class="bg-warning text-center py-2 px-4" v-if="notificationText">
  ...
  mounted: async function() {
    ...
    Cloud.on('session', (msg)=>{
      switch(msg.verb) {
        case 'signedOut':
          this.notificationText = 'You signed out in another tab or window. Reload the page to refresh your session.';
          break;
        default:
