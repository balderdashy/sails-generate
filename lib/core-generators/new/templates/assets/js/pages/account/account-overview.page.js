    ...
    clickStripeCheckoutButton: function() {
      ...
      this.checkoutHandler.open({
        ...
        token: async (stripeData)=> {
          ...
          var normalizedBillingCardInfo = {
            billingCardLast4: stripeData.card.last4,
            billingCardBrand: stripeData.card.brand,
            billingCardExpMonth: String(stripeData.card.exp_month),
            billingCardExpYear: String(stripeData.card.exp_year)
          };
          ...
          if (!this.cloudError) {
            Object.assign(this.me, normalizedBillingCardInfo);
