...
module.exports = {
  ...
  ***************************************************************************/
  ...
  /***************************************************************************
  *                                                                          *
  * Uncomment below to enable CSRF protection by default for all routes. You *
  * can turn off CSRF for a specific route by adding `csrf: false` to the    *
  * route definition in `config/routes.js`.                                  *
  *                                                                          *
  * In many cases, you'll want to set this in `config/security.js` instead   *
  * so that your app can be tested with CSRF protection turned on in         *
  * development mode.                                                        *
  *                                                                          *
  ***************************************************************************/
  security: {
