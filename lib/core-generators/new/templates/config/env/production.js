...
module.exports = {
  ...
  ***************************************************************************/
  session: {
    ...
    * proxies, the `trustProxy` setting under `http` must be configured in     *
    * order for `secure: true` to work.                                        *
    *                                                                          *
  ...
  ***************************************************************************/
  ...
  http: {
    ...
    * relies on knowing the original IP address that a request came from. See  *
    * https://expressjs.com/en/guide/behind-proxies.html for more info.        *
    *                                                                          *
