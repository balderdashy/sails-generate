...
module.exports = function getPackageJsonData(scope) {
  ...
  if(scope.caviar) {
    _.extend(declaredDeps, {
      ...
      'sails-stdlib': '^0.8.0-3',

      // Stripe
      'machinepack-stripe': '^2.0.0'
  ...
  var currentNodeMajorVersion = +(process.version.match(RX_NODE_MAJOR_DOT_MINOR)[1]);
  if (currentNodeMajorVersion < 4) {
    console.error();
    console.error('------------------------------------------------------------------------------------------');
  ...
  var isCurrentNodeVersionCapableOfAwait = process.version.match(RX_NODE_MAJOR_DOT_MINOR) && ( currentNodeMajorVersion >= 7.9);
  if(!isCurrentNodeVersionCapableOfAwait) {
    ...
    // console.log();
    // console.log('•·––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––·•');
    // console.log('Nice!  It looks like your version of Node.js supports `await`.');
    // console.log('⚓');
