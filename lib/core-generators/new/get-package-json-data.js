...
module.exports = function getPackageJsonData(scope) {
  ...
  var declaredDeps = {
    ...
    'sails-hook-grunt': '^2.2.1',// ««FUTURE: potential changes here (see https://sailsjs.com/roadmap)
  ...
  // If this app is being generated with --caviar, then include a few extra dependencies.
  if(scope.caviar) {
    _.extend(declaredDeps, {

      // Bring in standard library of organic helpers (formerly `sails-stdlib`)
      'sails-hook-organics': '^0.12.0',
