  ...
  var defaultPackageJSONContent = {
    ...
    scripts: {
      ...
      lint:
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        // FUTURE: Maybe set up something like:
        // ```
      ...
      'custom-tests':
        ...
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      deploy:
        'echo \'Warning: This script assumes that this app can be deployed\' && echo \'simply by force-pushing on top of the *deploy* branch.\' && echo \'\' && echo \'\' && echo \'Let us see if you are ready to deploy...\' && echo \'--\' && git status && echo \'\' && echo \'--\' && echo \'I hope you are on the master branch and have everything pulled and stuff.\' && echo \'Press CTRL+C to cancel.\' && echo \'(you have five seconds)\' && sleep 5 && echo \'\' && echo \'Alright, here we go.  No turning back now!\' && echo \'Deploying as version:\' && npm version patch && echo \'\' && git push origin master && git push --tags && git checkout -b predeploy && node node_modules/grunt/bin/grunt buildProd && mv www .www && git add .www && git commit -am \'Automatically compiled assets.\' && git push origin predeploy && git checkout master && git push origin +predeploy:deploy && git push --tags && git branch -D predeploy && git push origin :predeploy && echo \'\' && echo \'--\' && echo \'OK, done.  It should be live momentarily.\' && echo \'(if you get impatient, check your Heroku dashboard for status)\'',
      debug:
        'node debug app.js'
    },
    main: 'app.js',
