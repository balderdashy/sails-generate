...
module.exports = function(options, sb) {
  ...
  fsx.copy(absSrcPath, options.rootPath, {
    ...
    if (err) {
      console.log('Using templatesDirectory:',options.templatesDirectory);
      console.log('Using templatePath:',options.templatePath);
      console.log('FAILD TO COPY '+absSrcPath,err); }
