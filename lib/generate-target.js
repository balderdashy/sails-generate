  ...
  try {
    ...
    while (true) {
      ...
      if (target.onlyIf !== undefined) {
        ...
        // console.log('found `onlyIf` target ('+target.onlyIf+').   Assumed relative path: ',require('path').relative(require('path').dirname(scope.topLvlRootPath), scope.rootPath));
        // console.log('found `onlyIf` target ('+target.onlyIf+').  '+require('path').dirname(scope.topLvlRootPath)+'   Assumed relative path: ',require('path').relative(scope.topLvlRootPath, scope.rootPath));
        // console.log('found `onlyIf` target ('+target.onlyIf+').  Its topLvlRootPath: ',scope.topLvlRootPath, '  Its scope.rootPath: ',scope.rootPath);
      }//ﬁ
