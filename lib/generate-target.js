...
module.exports = function generateTarget(options, done) {
  ...
  if (!_.isUndefined(parentGenerator.templatesDirectory)) {
    ...
    // console.log('used templatesDirectory from parent generator.  Here is daddy\'s templatesDirectory ',scope.templatesDirectory);
    // console.log('here is what scope.templatesDirectory would have been: ',scope.templatesDirectory);
  }
  ...
  async.until(
    ...
    function afterwards(err) {
      ...
      // callback:
      console.log('passing in scope.templatesDirectory of `'+scope.templatesDirectory+'` when calling out to target:',target);
