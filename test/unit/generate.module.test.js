...
// var GenerateModuleHelper = require('root-require')('lib/helpers/module');
...
// 				generator: {}
// 			};
// 			this.options.rootPath = this.sailsHeap.alloc();
// 		});
...
// 			before(function (cb) {
// 				this.options.rootPath = this.sailsHeap.alloc();
// 				this.sailsHeap.touch(this.options.rootPath, cb);
// 			});
...
// 			before(function (cb) {
// 				this.options.rootPath = this.sailsHeap.alloc();
// 				this.sailsHeap.mkdirp(this.options.rootPath, cb);
// 			});
